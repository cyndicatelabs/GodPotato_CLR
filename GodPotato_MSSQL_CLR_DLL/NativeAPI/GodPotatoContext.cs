...
namespace GodPotato.NativeAPI
{
    public class GodPotatoContext
    {
        ...
        public bool IsYaknowThis1Hook { get; private set; }
        ...
        protected void PipeServer()
        {
            ...
            try
            {
                ...
                if (pipeServerHandle != BAD_HANLE)
                {
                    ...
                    {
                        ConsoleWriter.WriteLine("[!] CNP tyimout ");
                    }
        ...
        public void HookRPC()
        {
            ...
            IsYaknowThis1Hook = true;
        }
        public void Restore()
        {
            if (IsYaknowThis1Hook)
            {
